...
<div class="box5_page">
    <table style=" width: 710px">
        <tr>
            <th>
                <div class="box6_page color9-1">
                    {{$name}}
                </div>
            </th>
            <th>
                <div class="box7_page color9-1">
                    Minorista
                </div>
            </th>
        </tr>
            ...
            @endif
                    <th class="columna">
                        <div class="box_table"
                            ...
                            <div class="big_text">
                                <div class="text1" id="text1_color_page9">50 Combos </div> 
                                <div class="text2" id="text2_color_page9">Total de planchas: 300</div> 
