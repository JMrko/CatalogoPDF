...
<div class="circle_page11">•</div>
<div class="box2_page" id="color_page11">Creciendo Juntos</div>
<div class="box2_page3">Actualización 5 de Agosto del 2021</div>
<div class="box4_page" id="color_page11">Family</div>
<div class="box5_page">
    <table style=" width: 710px">
        <tr>
            <th>
                <div class="box6_page color11-1">
                    {{$name}}
                </div>
            </th>
            <th>
                <div class="box7_page color11-1">
                    Minorista
                </div>
            </th>
        </tr>
    ...
    <table >
        @foreach ( range (0,5) as $valve) 
            ...
            @endif
                    <th class="columna">
                        <div class="box_table"
                            id="box_table_color_page11">
                            <div class="big_text">
                                <div class="text1" id="text1_color_page11">50 Combos </div> 
                                <div class="text2" id="text2_color_page11">Total de planchas: 300</div> 
...
<img class="body2_page" src='../public/images/Azul-15-15.jpg' alt="">