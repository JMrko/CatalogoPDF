...
@foreach ( range(0,10) as $value ) 
            @if ($loop->first || $loop->index == 6 || $loop->index == 12 || $loop->index == 18)
                ...
                <div class="box5_page">
                    <table style=" width: 710px">
                        <tr>
                            <th>
                                <div class="box6_page @if($loop->first) color3-1 @else color3-2 @endif ">
                                {{-- <div class="box7_page color3-1"> --}}
                                    {{$name}}
                                </div>
                            </th>
                            <th>
                                <div class="box7_page @if($loop->first) color3-1 @else color3-2 @endif ">
                                    Minorista
                                </div>
                            </th>
                        </tr>
            ...
            @endif
                ...
                @endif  
            @if ($loop->last || $loop->index == 5 || $loop->index == 11 || $loop->index == 17) 
                </table>
                </div>
