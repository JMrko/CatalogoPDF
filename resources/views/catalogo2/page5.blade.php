...
<div class="box4_page" id="color_page5">Fem</div>
<div class="box5_page">
    <table style=" width: 710px">
        <tr>
            <th>
                <div class="box6_page color5-1">
                    {{$name}}
                </div>
            </th>
            <th>
                <div class="box7_page color5-1">
                    Minorista
                </div>
            </th>
        </tr>
    ...
    <table >
        @foreach ( range (0,5) as $valve) 
            ...
            @endif
                    <th class="columna">
                        <div class="box_table"
                            id="box_table_color_page5">
                            <div class="big_text">
                                <div class="text1" id="text1_color_page5">50 Combos </div> 
                                <div class="text2" id="text2_color_page5">Total de planchas: 300</div> 
